	...
	$defaultSpanText = DEFAULT_SPAN_TEXT)
{
	...
	/**
	 * For admin users: uncomment the next line and comment the
...
class simple_html_dom_node
{
	...
	function find($selector, $idx = null, $lowercase = false)
	{
		...
		// find each selector
		for ($c = 0; $c < $count; ++$c) {
			// The change on the below line was documented on the admin
...
class simple_html_dom
{
	...
	function clear()
	{
		...
		// This add next line is documented in the admin repository.
